        ...
        <div className="fixed top-0 right-0 px-6 py-4 sm:block">
          {auth.user ? (
            ...
            <>
              ...
              <Link href={route('register')} className="ml-4 text-sm text-gray-700 underline dark:text-gray-500">
                Register
              </Link>
            </>
          )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
              <div className="p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4 text-lg font-semibold leading-7">
                    <a href="https://laravel.com/docs" className="text-gray-900 underline dark:text-white">
                      Documentation
                    </a>
                  </div>
                </div>
              ...
              <div className="p-6 border-t border-gray-200 dark:border-gray-700">
                <div className="flex items-center">
                  ...
                  <div className="ml-4 text-lg font-semibold leading-7">
                    <a href="https://laravel-news.com/" className="text-gray-900 underline dark:text-white">
                      Laravel News
                    </a>
                  </div>
                </div>
