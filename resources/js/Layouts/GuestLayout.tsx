...
export default function Guest({ title, children }: { title: string; children: string | JSX.Element }) {
  return (
    <div className="flex flex-row items-center justify-center min-h-screen pt-6 bg-gray-100 dark:bg-gray-700 sm:pt-0">
      <div className="flex justify-center bg-red basis-3/5 ">
        <img src={moneyImage} alt={'Money Tracker App'} className={`max-h-96 max-w-6xl`} />
      </div>
      <div className="grow flex justify-start flex-col items-center bg-[#a6d09d] dark:bg-[#477d3c] min-h-screen relative">
